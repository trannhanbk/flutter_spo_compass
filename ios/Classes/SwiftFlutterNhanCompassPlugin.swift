...
public class SwiftFlutterNhanCompassPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, CLLocationManagerDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterEventChannel.init(name: "nhantranbk/flutter_nhan_compass", binaryMessenger: registrar.messenger())
    _ = SwiftFlutterNhanCompassPlugin(channel: channel);
  }
