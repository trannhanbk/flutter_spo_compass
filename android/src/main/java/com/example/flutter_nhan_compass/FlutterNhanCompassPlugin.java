package com.example.flutter_nhan_compass;
...
public final class FlutterNhanCompassPlugin implements FlutterPlugin, ActivityAware, StreamHandler {
    ...
    public FlutterNhanCompassPlugin() {
    }


    // public static void registerWith(Registrar registrar) {
    //     EventChannel channel = new EventChannel(registrar.messenger(), "nhantranbk/flutter_nhan_compass");
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        sensorEventChannel = new EventChannel(binding.getBinaryMessenger(), "nhantranbk/flutter_nhan_compass");
